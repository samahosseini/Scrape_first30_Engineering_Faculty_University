    ...
    for div in faculty_divs:
        ...
        if position_tag:
            ...
            if research_focus_text and isinstance(research_focus_text, str):
                ...
                faculty_info['Research Focus'] = research_focus_text if (
                    research_focus_text) else 'N/A'
...
if __name__ == "__main__":
    ...
    if faculty_info_list:
        csv_file_path = "D:\\Files\\Upwork\\Scrape\\Us_30_Uni_engineering\\Result\\1_MIT\\MIT_1_DataSystemsSociety.csv"
